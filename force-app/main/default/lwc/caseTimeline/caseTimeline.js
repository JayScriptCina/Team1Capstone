// Name: Jay Cina
// Date: 02/04/2026
// Desc: A timeline which displays a dynamic list (caseList), and audit log attached to a select case (caseActivityList), and details panel (caseDetail) if a case is clicked
